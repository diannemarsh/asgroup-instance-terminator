...
public class TerminateInstanceJob {
    ...
    public void run() throws InterruptedException {
        LOGGER.info("Starting Instance Termination job at {}", System.currentTimeMillis());
            ...
            for (final AutoScalingGroup autoScalingGroup : allAutoScalingGroups) {
                ...
                ruleHandler.applyRules(autoScalingGroup, new AsyncHandler<Boolean>() {
                    ...
                    public void handleResponse(Boolean res) {
                        LOGGER.info("Flag to terminate instance on com.sample.autoscaling group {} is {}",
        ...
        LOGGER.info("Finished Instance Termination job at {}", System.currentTimeMillis());
    }
